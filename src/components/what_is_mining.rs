    ...
    render! {
        div {
            ...
            p {
                ...
                "In this post, we'll dig into details and unpack what mining means for you, one concept at a time."
            }
            p {
            ...
            p {
                span {
                    class: "font-bold",
                    "Mars guarantees everyone can participate in mining and win. "
                }
                ...
                "Rather than setting up every miner in a winner-take-all competition against one another, Mars gives each miner their own personalized computational challenge. "
                "As long as you provide a valid solution to your own individual puzzle, Mars guarantees your will earn a piece of the supply. "
            ...
            p {
                ...
                "Mars opens the door to everyone and offers a digital currency that regular, everyday people can mine and win. "
            }
        }
    }
}
