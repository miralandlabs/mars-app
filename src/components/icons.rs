...
#[component]
pub fn MarsIcon<'a>(cx: Scope<'a, IconProps<'a>>) -> Element {
...
pub fn MarsLogoIcon<'a>(cx: Scope<'a, IconProps<'a>>) -> Element {
    let class = cx.props.class.unwrap_or("");
    render! {
        svg {
            view_box: "0 0 350 350",
...
pub fn MarsWordmarkIcon<'a>(cx: Scope<'a, IconProps<'a>>) -> Element {
    let class = cx.props.class.unwrap_or("");
    render! {
        svg {
            view_box: "0 0 350 350",
